...
public class ContinentsEndPoint extends AbstractEndPoint {
    ...
    /**
     * @param ContinentId id continent
     * @return Continent
     * @throws NotFoundException si continent n'existe pas
     */
    ...
    /**
     * Liste de toutes les continents autorisés avec les relations définies
     *
